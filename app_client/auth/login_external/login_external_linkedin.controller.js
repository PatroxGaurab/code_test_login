(function() {
  ...
  angular
    .module('meanApp')
    .controller('login_external_linkedinCtrl', ['$location','$scope','authentication','$routeParams','meanData',login_external_linkedinCtrl]);

    function login_external_linkedinCtrl ($location,$scope,authentication,$routeParams, meanData) {
    ...
    authentication.linkedinCallback($routeParams)
