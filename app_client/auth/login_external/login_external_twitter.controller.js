(function() {
  ...
  angular
    .module('meanApp')
    .controller('login_external_twitterCtrl', ['$location','$scope','authentication','$routeParams','meanData',login_external_twitterCtrl]);

    function login_external_twitterCtrl ($location,$scope,authentication,$routeParams, meanData) {
    ...
    authentication.twitterCallback($routeParams)
